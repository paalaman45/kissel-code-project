  ...
  const icons = {
    ...
    'ui-design': () => h('svg', {
      ...
      h('path', {
        ...
        'stroke-linejoin': 'round',
        'stroke-width': '2',
        d: 'M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zM21 5a2 2 0 00-2-2h-4a2 2 0 00-2 2v7a2 2 0 002 2h4a2 2 0 002-2V5z'
      })
    ]),

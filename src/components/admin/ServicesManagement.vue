          ...
          <form @submit.prevent="saveService" class="space-y-4">
            ...
            <div>
              ...
              <div class="space-y-3">
                ...
                <div v-else class="w-32 h-20 bg-gray-100 rounded-lg flex items-center justify-center border border-dashed border-gray-300">
                ...
                />
                <p class="text-xs text-gray-500">Enter the direct URL to your service image.</p>
              </div>
            </div>
